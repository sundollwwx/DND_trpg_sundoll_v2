...
| M2 | Revision、HEAD/Revision 扫描恢复、generation 冲突保护、Journal、blob、便携包、命令契约；M2 定向 15/15 | Journal 命令 Payload 重放、异步保存、真实磁盘故障 | Windows 强制退出、原子写盘与跨平台互开矩阵 |
| M3 | 批量绘制、几何工具、五图层、运行时索引、Delta Undo、Dirty Region、缓存；最新全量证据为 41/41 EditMode | 正式 Workbench、选择/复制旋转、门箱对象、性能门槛 | Windows 性能与构建矩阵 |
